...
(async () => {
  ...
  let company = "paul bailey consturction";
  ...
  await page.goto(links[1], { waitUntil: "domcontentloaded" });
  ...
  await page.goto(links[2], { waitUntil: "domcontentloaded" });
  ...
  await page.goto(links[3], { waitUntil: "domcontentloaded" });
  ...
  await page.goto(links[4], { waitUntil: "domcontentloaded" });
